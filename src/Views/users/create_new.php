        ...
        <div>
            ...
            <div class="mt-2 space-y-2">
                <label class="inline-flex items-center">
                    <input type="checkbox" name="permissions[]" value="manage_rooms" class="form-checkbox">
                    <span class="ml-2">Gerenciar Quartos</span>
                </label>
                <label class="inline-flex items-center">
                    <input type="checkbox" name="permissions[]" value="manage_bookings" class="form-checkbox">
                    <span class="ml-2">Gerenciar Reservas</span>
                </label>
                <label class="inline-flex items-center">
                    <input type="checkbox" name="permissions[]" value="manage_finance" class="form-checkbox">
                    <span class="ml-2">Gerenciar Financeiro</span>
                </label>
                <label class="inline-flex items-center">
                    <input type="checkbox" name="permissions[]" value="manage_users" class="form-checkbox">
