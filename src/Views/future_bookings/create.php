<div class="py-6 max-w-md mx-auto">
    <h1 class="text-2xl font-semibold text-gray-900 mb-6">Nova Reserva Futura</h1>

    <form method="POST" action="/reservas/futuras/nova" class="space-y-6 bg-white p-6 rounded shadow">
        ...
        <div>
            ...
            <select name="room_id" id="room_id" required
                ...
                <option value="<?= $room['id'] ?>"><?= htmlspecialchars($room['number']) ?> - <?= ucfirst($room['type']) ?></option>
                <?php endforeach; ?>
            </select>
        </div>
